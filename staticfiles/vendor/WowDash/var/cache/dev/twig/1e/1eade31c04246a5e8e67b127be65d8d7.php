...
/* dashboard/index9.html.twig */
class __TwigTemplate_a4c2be7de9bbc43ddfa5472f01dda2d9 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "dashboard/index9.html.twig"));

        $this->parent = $this->loadTemplate("./layout/layout.html.twig", "dashboard/index9.html.twig", 1);
    ...
    <div class=\"grid grid-cols-1 xl:grid-cols-12 gap-6\">
                ...
                <div class=\"card-body p-5\">
                    <div class=\"grid grid-cols-1 md:grid-cols-12 gap-4\">
                        <div class=\"col-span-12 md:col-span-4\">
                            <div class=\"trail-bg h-full text-center flex flex-col justify-between items-center p-4 rounded-lg bg-cover bg-no-repeat bg-center\" style=\"background-image: url('/assets/images/home-nine/trail-bg.png');\">
                        ...
                        <div class=\"flex flex-col gap-6\">
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-primary-100 dark:bg-primary-600/20 shrink-0\">
                                    <img src=\"";
        // line 123
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/ticket1.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                            ...
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-warning-100 dark:bg-warning-600/20 shrink-0\">
                                    <img src=\"";
        // line 132
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/ticket2.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
                                    <h6 class=\"text-base mb-0 font-bold\">172</h6>
                            ...
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-purple-100 dark:bg-purple-600/20 shrink-0\">
                                    <img src=\"";
        // line 141
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/ticket3.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
                                    <h6 class=\"text-base mb-0 font-bold\">172</h6>
                        ...
                        <div class=\"flex items-center justify-between gap-4 mb-6\">
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-success-200 dark:bg-success-600/20 shrink-0\">
                                    <img src=\"";
        // line 193
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/payment1.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
                        ...
                        <div class=\"flex items-center justify-between gap-4 mb-6\">
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-info-200 dark:bg-info-600/20 shrink-0\">
                                    <img src=\"";
        // line 205
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/payment2.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
                        ...
                        <div class=\"flex items-center justify-between gap-4 mb-6\">
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-warning-200 dark:bg-warning-600/20 shrink-0\">
                                    <img src=\"";
        // line 217
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/payment3.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
                        ...
                        <div class=\"flex items-center justify-between gap-4 mb-0\">
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-purple-200 dark:bg-purple-600/20 shrink-0\">
                                    <img src=\"";
        // line 229
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/payment4.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
                                ...
                                <div class=\"max-h-[266px] overflow-y-auto scroll-sm pe-1\">
                                    <div class=\"flex items-center justify-between gap-4 mb-2 pb-2\">
                                        <div class=\"flex items-center w-full\">
                                            <img src=\"";
        // line 265
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/flags/flag1.png"), "html", null, true);
        yield "\" alt=\"\" class=\"w-[40px] h-[40px] rounded-[50%] shrink-0 me-3\">
                                            <div class=\"flex-grow-1\">
                                    ...
                                    <div class=\"flex items-center justify-between gap-4 mb-2 pb-2\">
                                        <div class=\"flex items-center w-full\">
                                            <img src=\"";
        // line 283
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/flags/flag2.png"), "html", null, true);
        yield "\" alt=\"\" class=\"w-[40px] h-[40px] rounded-[50%] shrink-0 me-3\">
                                            <div class=\"flex-grow-1\">
                                    ...
                                    <div class=\"flex items-center justify-between gap-4 mb-2 pb-2\">
                                        <div class=\"flex items-center w-full\">
                                            <img src=\"";
        // line 301
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/flags/flag3.png"), "html", null, true);
        yield "\" alt=\"\" class=\"w-[40px] h-[40px] rounded-[50%] shrink-0 me-3\">
                                            <div class=\"flex-grow-1\">
                                    ...
                                    <div class=\"flex items-center justify-between gap-4 mb-2 pb-2\">
                                        <div class=\"flex items-center w-full\">
                                            <img src=\"";
        // line 319
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/flags/flag4.png"), "html", null, true);
        yield "\" alt=\"\" class=\"w-[40px] h-[40px] rounded-[50%] shrink-0 me-3\">
                                            <div class=\"flex-grow-1\">
                                    ...
                                    <div class=\"flex items-center justify-between gap-4 mb-2 pb-2\">
                                        <div class=\"flex items-center w-full\">
                                            <img src=\"";
        // line 337
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/flags/flag5.png"), "html", null, true);
        yield "\" alt=\"\" class=\"w-[40px] h-[40px] rounded-[50%] shrink-0 me-3\">
                                            <div class=\"flex-grow-1\">
                            ...
                            <div class=\"col-span-12 md:col-span-3 sm:col-span-6 flex flex-col justify-end\">
                                <div class=\"flex flex-col items-center p-6 pt-4 rounded-t-xl bg-gradient-to-b from-[#ffba4540] to-[#f4743540]\" style=\"min-height: 50%;\">
                                    <span class=\"w-[40px] h-[40px] flex shrink-0 justify-center items-center bg-warning-600 rounded-[50%] mb-3\">
                                        <img src=\"";
        // line 396
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/source-icon1.png"), "html", null, true);
        yield "\" alt=\"\">
                                    </span>
                            ...
                            <div class=\"col-span-12 md:col-span-3 sm:col-span-6 flex flex-col justify-end\">
                                <div class=\"flex flex-col items-center p-6 pt-4 rounded-t-xl bg-gradient-to-b from-[#fc788a40] to-[#98168b40]\" style=\"min-height: 66%;\">
                                    <span class=\"w-[40px] h-[40px] flex shrink-0 justify-center items-center bg-purple-600 rounded-[50%] mb-3\">
                                        <img src=\"";
        // line 405
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/source-icon2.png"), "html", null, true);
        yield "\" alt=\"\">
                                    </span>
                            ...
                            <div class=\"col-span-12 md:col-span-3 sm:col-span-6 flex flex-col justify-end\">
                                <div class=\"flex flex-col items-center p-6 pt-4 rounded-t-xl bg-gradient-to-b from-[#19cfef40] to-[#0d6ab840]\" style=\"min-height: 82%;\">
                                    <span class=\"w-[40px] h-[40px] flex shrink-0 justify-center items-center bg-primary-600 rounded-[50%] mb-3\">
                                        <img src=\"";
        // line 414
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/source-icon3.png"), "html", null, true);
        yield "\" alt=\"\">
                                    </span>
                            ...
                            <div class=\"col-span-12 md:col-span-3 sm:col-span-6 flex flex-col justify-end\">
                                <div class=\"flex flex-col items-center p-6 pt-4 rounded-t-xl bg-gradient-to-b from-[#86dd6640] to-[#028c4b40]\" style=\"min-height: 96%;\">
                                    <span class=\"w-[40px] h-[40px] flex shrink-0 justify-center items-center bg-success-600 rounded-[50%] mb-3\">
                                        <img src=\"";
        // line 423
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/source-icon4.png"), "html", null, true);
        yield "\" alt=\"\">
                                    </span>
                        ...
                        <div class=\"flex items-center justify-between gap-4\">
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-purple-100 dark:bg-purple-600/20 shrink-0\">
                                    <img src=\"";
        // line 446
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/socials1.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
                        ...
                        <div class=\"flex items-center justify-between gap-4\">
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-warning-100 dark:bg-warning-600/20 shrink-0\">
                                    <img src=\"";
        // line 460
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/socials2.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
                        ...
                        <div class=\"flex items-center justify-between gap-4\">
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-info-100 dark:bg-info-600/20 shrink-0\">
                                    <img src=\"";
        // line 474
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/socials3.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
                        ...
                        <div class=\"flex items-center justify-between gap-4\">
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-success-100 dark:bg-success-600/20 shrink-0\">
                                    <img src=\"";
        // line 488
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/socials4.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
                        ...
                        <div class=\"flex items-center justify-between gap-4\">
                            <div class=\"flex items-center gap-4\">
                                <div class=\"w-[40px] h-[40px] rounded-[50%] flex justify-center items-center bg-danger-100 dark:bg-danger-600/20 shrink-0\">
                                    <img src=\"";
        // line 502
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/home-nine/socials5.png"), "html", null, true);
        yield "\" alt=\"\" class=\"\">
                                </div>
                                <div class=\"flex-grow-1\">
        ...
        yield "\" alt=\"\" class=\"w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden\">
                                            <div class=\"flex-grow-1\">
...
";
    ...
    {
        return "dashboard/index9.html.twig";
    }
    ...
    {
        return array (  763 => 617,  745 => 602,  727 => 587,  709 => 572,  691 => 557,  647 => 516,  630 => 502,  613 => 488,  596 => 474,  579 => 460,  562 => 446,  536 => 423,  524 => 414,  512 => 405,  500 => 396,  455 => 354,  435 => 337,  414 => 319,  393 => 301,  372 => 283,  351 => 265,  312 => 229,  297 => 217,  282 => 205,  267 => 193,  212 => 141,  200 => 132,  188 => 123,  67 => 4,  57 => 3,  40 => 1,);
    }
...
{% endblock content %}", "dashboard/index9.html.twig", "E:\\Symfony\\WowDash\\templates\\dashboard\\index9.html.twig");
    }
}
