...
class __TwigTemplate_82d4996b4c6a4773ddd5d31afb860a34 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 1
        yield "<div class=\"navbar-header border-b border-neutral-200 dark:border-neutral-600\">
    <div class=\"flex items-center justify-between\">
            ...
            <div class=\"flex flex-wrap items-center gap-3\">
                ...
                <div class=\"hidden sm:inline-block\">
                    <button data-dropdown-toggle=\"dropdownInformation\" class=\"has-indicator w-10 h-10 bg-neutral-200 dark:bg-neutral-700 dark:text-white rounded-full flex justify-center items-center\" type=\"button\">
                        <img src=\"";
        // line 33
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/lang-flag.png"), "html", null, true);
        yield "\" alt=\"image\" class=\"w-6 h-6 object-cover rounded-full\">
                    </button>
        ...
        yield "\" alt=\"\" class=\"w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0\">
                                ...
                                <div class=\"form-check style-check flex items-center justify-between\">
                                    <label class=\"form-check-label line-height-1 font-medium text-secondary-light\" for=\"Bangladesh\">
                                        <span class=\"text-black hover-bXg-transparent hover-text-primary flex items-center gap-3\">
                                            <img src=\"";
        // line 98
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/flags/flag6.png"), "html", null, true);
        yield "\" alt=\"\" class=\"w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0\">
                                ...
                                <div class=\"form-check style-check flex items-center justify-between\">
                                    <label class=\"form-check-label line-height-1 font-medium text-secondary-light\" for=\"India\">
                                        <span class=\"text-black hover-bXg-transparent hover-text-primary flex items-center gap-3\">
                                            <img src=\"";
        // line 108
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/flags/flag7.png"), "html", null, true);
        yield "\" alt=\"\" class=\"w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0\">
                                ...
                                <div class=\"form-check style-check flex items-center justify-between\">
                                    <label class=\"form-check-label line-height-1 font-medium text-secondary-light\" for=\"Koria\">
                                        <span class=\"text-black hover-bXg-transparent hover-text-primary flex items-center gap-3\">
                                            <img src=\"";
        // line 118
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/flags/flag8.png"), "html", null, true);
        yield "\" alt=\"\" class=\"w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0\">
        ...
        // line 144
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/notification/profile-3.png"), "html", null, true);
        yield "\" alt=\"Joseph image\">
                            ...
                            <a href=\"javascript:void(0)\" class=\"flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600 justify-between gap-1\">
                                <div class=\"flex items-center gap-3\">
                                    <div class=\"flex-shrink-0 relative\">
                                        <img class=\"rounded-full w-11 h-11\" src=\"";
        // line 160
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/notification/profile-4.png"), "html", null, true);
        yield "\" alt=\"Joseph image\">
                                        <span class=\"absolute end-[2px] bottom-[2px] w-2.5 h-2.5 bg-success-500 border border-white rounded-full dark:border-gray-600\"></span>
                                    </div>
                                    <div>
                            ...
                            <a href=\"javascript:void(0)\" class=\"flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600 justify-between gap-1\">
                                <div class=\"flex items-center gap-3\">
                                    <div class=\"flex-shrink-0 relative\">
                                        <img class=\"rounded-full w-11 h-11\" src=\"";
        // line 176
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/notification/profile-5.png"), "html", null, true);
        yield "\" alt=\"Joseph image\">
                                        <span class=\"absolute end-[2px] bottom-[2px] w-2.5 h-2.5 bg-success-500 border border-white rounded-full dark:border-gray-600\"></span>
                                    </div>
                                    <div>
                            ...
                            <a href=\"javascript:void(0)\" class=\"flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600 justify-between gap-1\">
                                <div class=\"flex items-center gap-3\">
                                    <div class=\"flex-shrink-0 relative\">
                                        <img class=\"rounded-full w-11 h-11\" src=\"";
        // line 192
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/notification/profile-6.png"), "html", null, true);
        yield "\" alt=\"Joseph image\">
                                        <span class=\"absolute end-[2px] bottom-[2px] w-2.5 h-2.5 bg-success-500 border border-white rounded-full dark:border-gray-600\"></span>
                                    </div>
                                    <div>
                            ...
                            <a href=\"javascript:void(0)\" class=\"flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600 justify-between gap-1\">
                                <div class=\"flex items-center gap-3\">
                                    <div class=\"flex-shrink-0 relative\">
                                        <img class=\"rounded-full w-11 h-11\" src=\"";
        // line 208
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/notification/profile-7.png"), "html", null, true);
        yield "\" alt=\"Joseph image\">
                                        <span class=\"absolute end-[2px] bottom-[2px] w-2.5 h-2.5 bg-success-500 border border-white rounded-full dark:border-gray-600\"></span>
                                    </div>
                                    <div>
        ...
        yield "\" alt=\"Joseph image\">
                ...
                <button data-dropdown-toggle=\"dropdownProfile\" class=\"flex justify-center items-center rounded-full\" type=\"button\">
                    <img src=\"";
        // line 321
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/user.png"), "html", null, true);
        yield "\" alt=\"image\" class=\"w-10 h-10 object-fit-cover rounded-full\">
                </button>
    ...
    {
        return array (  450 => 347,  442 => 342,  434 => 337,  415 => 321,  376 => 285,  345 => 257,  293 => 208,  274 => 192,  255 => 176,  236 => 160,  217 => 144,  188 => 118,  175 => 108,  162 => 98,  149 => 88,  136 => 78,  123 => 68,  110 => 58,  97 => 48,  79 => 33,  45 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("<div class=\"navbar-header border-b border-neutral-200 dark:border-neutral-600\">
    <div class=\"flex items-center justify-between\">
        <div class=\"col-auto\">
            <div class=\"flex flex-wrap items-center gap-[16px]\">
                <button type=\"button\" class=\"sidebar-toggle\">
...
</div>", "partials/navbar.html.twig", "E:\\Symfony\\WowDash\\templates\\partials\\navbar.html.twig");
    }
}
