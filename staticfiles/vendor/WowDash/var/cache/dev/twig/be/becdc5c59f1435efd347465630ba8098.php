...
/* pricing.html.twig */
class __TwigTemplate_d1e1b47b6aecc492afebc0b617eee558 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "pricing.html.twig"));

        $this->parent = $this->loadTemplate("./layout/layout.html.twig", "pricing.html.twig", 1);
                                        ...
                                        <div class=\"relative rounded-[24px] overflow-hidden border py-6 lg:py-8 xl:py-10 2xl:py-[50px] px-5 lg:px-6 3xl:px-10 border-neutral-200 dark:border-neutral-600 bg-[#ebd7ff] dark:bg-purple-600/25\">
                                            <div class=\"flex items-center gap-4\">
                                                <span class=\"w-[72px] h-[72px] flex justify-center items-center rounded-2xl bg-white dark:bg-neutral-700\">
                                                    <img src=\"";
        // line 34
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/pricing/price-icon1.png"), "html", null, true);
        yield "\" alt=\"\">
                                                </span>
                                                <div class=\"\">
                                        ...
                                        <div class=\"relative rounded-[24px] overflow-hidden border border-primary-200 dark:border-primary-600 py-6 lg:py-8 xl:py-10 2xl:py-[50px] px-5 lg:px-6 3xl:px-10 2xl:-mt-[50px] 2xl:scale-105 z-[1] bg-primary-600 text-white\">
                                            ...
                                            <div class=\"flex items-center gap-4\">
                                                <span class=\"w-[72px] h-[72px] flex justify-center items-center rounded-2xl bg-white dark:bg-neutral-700\">
                                                    <img src=\"";
        // line 70
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/pricing/price-icon2.png"), "html", null, true);
        yield "\" alt=\"\">
                                                </span>
                                                <div class=\"\">
                                        ...
                                        <div class=\"relative rounded-[24px] overflow-hidden border py-6 lg:py-8 xl:py-10 2xl:py-[50px] px-5 lg:px-6 3xl:px-10 border-neutral-200 dark:border-neutral-600 bg-success-100 dark:bg-success-600/25\">
                                            <div class=\"flex items-center gap-4\">
                                                <span class=\"w-[72px] h-[72px] flex justify-center items-center rounded-2xl bg-white dark:bg-neutral-700\">
                                                    <img src=\"";
        // line 106
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/pricing/price-icon3.png"), "html", null, true);
        yield "\" alt=\"\">
                                                </span>
                                                <div class=\"\">
                                ...
                                <div class=\"relative rounded-[24px] overflow-hidden border py-6 lg:py-8 xl:py-10 2xl:py-[50px] px-5 lg:px-6 3xl:px-10 border-neutral-200 dark:border-neutral-600\">
                                    <div class=\"flex items-center gap-4\">
                                        <span class=\"w-[72px] h-[72px] flex justify-center items-center rounded-2xl bg-primary-50 dark:bg-primary-600/25\">
                                            <img src=\"";
        // line 285
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/pricing/price-icon4.png"), "html", null, true);
        yield "\" alt=\"\">
                                        </span>
                                        <div class=\"\">
                                            <span class=\"font-medium text-base text-secondary-light\">For individuals</span>
                                ...
                                <div class=\"relative rounded-[24px] overflow-hidden border py-6 lg:py-8 xl:py-10 2xl:py-[50px] px-5 lg:px-6 3xl:px-10 border-neutral-200 dark:border-neutral-600\">
                                    <div class=\"flex items-center gap-4\">
                                        <span class=\"w-[72px] h-[72px] flex justify-center items-center rounded-2xl bg-primary-50 dark:bg-primary-600/25\">
                                            <img src=\"";
        // line 357
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/pricing/price-icon5.png"), "html", null, true);
        yield "\" alt=\"\">
                                        </span>
                                        <div class=\"\">
                                            <span class=\"font-medium text-base text-secondary-light\">For big companies</span>
...
";
    ...
    {
        return array (  446 => 357,  407 => 321,  368 => 285,  298 => 218,  259 => 182,  220 => 146,  177 => 106,  138 => 70,  99 => 34,  67 => 4,  57 => 3,  40 => 1,);
    }
...
{% endblock content %}
", "pricing.html.twig", "E:\\Symfony\\WowDash\\templates\\pricing.html.twig");
    }
}
